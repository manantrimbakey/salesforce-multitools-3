...
export class CommandHandler {
    ...
    public static register(context: vscode.ExtensionContext): void {
        // Hello World command
        const helloWorldCmd = vscode.commands.registerCommand('salesforce-multitool.helloWorld', 
            this.handleHelloWorld);
        
        // Refresh connection command
        const refreshConnectionCmd = vscode.commands.registerCommand('salesforce-multitool.refreshConnection', 
    ...
    public static async initializeSalesforceConnection(forceRefresh = false): Promise<void> {
        ...
        try {
            ...
            if (username) {
                ...
                vscode.window.showWarningMessage('No default Salesforce username found. Please authorize an org first.');
            }
        } catch (error) {
